...
int filepath_remove_directory(filepath_t *dir_path)
{
    ...
    snprintf(search_path, sizeof(search_path), "%s*", dir_path_cpy.char_path);
    ...
    if (hFind != INVALID_HANDLE_VALUE)
    {
        ...
        do
        {
            ...
            int r2 = -1;
            char buf[MAX_PATH];
            snprintf(buf, sizeof(buf), "%s%s", dir_path_cpy.char_path, find_data.cFileName);
            ...
            r = r2;
        } while (!r && FindNextFileA(hFind, &find_data));
